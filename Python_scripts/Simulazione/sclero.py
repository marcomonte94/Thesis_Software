...
data = f'C:/Users/Marco/Desktop/Dati_MC/{inputFile}/detect1.raw'
...
for i in range(5, 6):
    ...
    for j in range(1, 251):
        ...
        np.savetxt(f'C:/Users/Marco/Desktop/Analisi_SiPM/Simulazione/{i}V/{inputFile}/Segnali_1/wf_{k}.txt', a)